const beatA = [
  7.04, 9.33, 11.45, 12.17, 12.89, 15.992, 17.14, 17.74, 19, 19.94, 20.46, 25.01, 25.51, 25.88, 26.81, 27.93, 28.21, 29.90, 30.58, 31.38, 32.89, 33.44, 35.97, 36.94,
  37.23, 38.19, 38.70, 40.77, 45.65, 49.11, 51.32, 60.01, 63.08, 64.12, 66.12, 69.26, 70.87, 72.4, 75.95, 77.05, 77.59, 77.97
];

const beatB = [
  7.86, 10.04, 10.712, 11.45, 12.17, 12.89, 15.992, 16.632, 17.74, 18.36, 19.50, 19.94, 20.46, 25.01, 25.51, 25.88, 26.81, 27.93, 28.21, 29.90, 30.58, 31.38, 32.89, 33.44,
  35.97, 36.94, 37.23, 38.19, 38.70, 40.77, 42.85, 44.34, 45.65, 49.11, 51.32, 58.24, 61.08, 62.07,  64.12, 66.12, 69.26, 72.4, 75.95, 77.05, 77.59, 77.97
];

const beatC = [
  8.57, 10.712, 11.45, 12.17, 12.89, 15.992, 16.632, 17.14, 18.36, 19, 19.94, 20.46, 25.01, 25.51, 25.88, 26.81, 27.93, 28.21, 29.90, 30.58, 31.38, 32.89, 33.44, 35.97,
  36.94, 38.19, 38.70, 40.77, 42.85, 44.34, 49.11, 51.32, 60.01, 61.08, 62.07, 63.08, 64.12, 66.12, 69.26, 70.87, 72.4, 75.95, 77.05, 77.59, 77.97
];
...
let loop = () => {
    ...
    if (audioContext.state == 'running') {
        ...
        imageAindex = Math.min(imageAindex, beatA.length - 1);
        ...
        if (wPressedThisCycle && !beatImgA.classList.contains("hidden")) {
            imageAindex = Math.min(imageAindex + 1, beatA.length - 1);
        ...
        imageBindex = Math.min(imageBindex, beatB.length - 1);
        ...
        if (spacePressedThisCycle && !beatImgB.classList.contains("hidden")) {
            imageBindex = Math.min(imageBindex + 1, beatB.length - 1);
        ...
        imageCindex = Math.min(imageCindex, beatC.length - 1);
        ...
        if (enterPressedThisCycle && !beatImgC.classList.contains("hidden")) {
            imageCindex = Math.min(imageCindex + 1, beatC.length - 1);
